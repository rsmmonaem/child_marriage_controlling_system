...
class Branch_manager extends CI_Controller {
    ...
    public function index() {
        ...
        if (!$this->session->userdata('user_name')) {
            ...
            $this->load->view('branch_manager/index');
        }
    }
    ...
    public function office_setup() {
        ...
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/zonal_office_list');
    }
    ...
    public function company_list() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/company_list');
    }
    ...
    function company_delete($com_id) {
        ...
        redirect("branch_manager/company_list");
    }
    ...
    function zonal_delete($zo_id) {
        ...
        redirect("branch_manager/zonal_office_list");
    }
    ...
    public function branch_list() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/branch_office_list');
    }
    ...
    function branch_delete($br_id) {
        ...
        redirect("branch_manager/branch_list");
    }
    ...
    public function bank_details() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/bank_details_list');
    }
    ...
    function bank_delete($b_id) {
        ...
        redirect("branch_manager/bank_details");
    }
    ...
    public function bank_deposit_list() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/bank_deposit_list');
    }
    ...
    public function create_branch_manager() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/create_branch_manager');
    }
    ...
    public function branch_manager_list() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/branch_manager_list');
    }
    ...
    public function edit_branch_manager() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/edit_branch_manager');
    }
    ...
    function delete_branch_manager($zm_id, $path) {
        ...
        redirect("branch_manager/branch_manager_list");
    }
    ...
    public function branch_manager_list_search() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/branch_manager_list_search');
    }
    ...
    public function create_field_worker() {
        ...
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/create_field_worker');
    }
    ...
    public function field_worker_list() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/field_worker_list');
    }
    ...
    public function edit_field_worker() {
        ...
        $this->load->model('distributor_management_model', 'dmm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/edit_field_worker');
    }
    ...
    function delete_field_worker($zm_id, $path) {
        ...
        redirect("branch_manager/field_worker_list");
    }
    ...
    public function field_worker_list_search() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/field_worker_list_search');
    }
    ...
    public function create_customer() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/create_customer');
    }
    ...
    public function customer_list() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/customer_list');
    }
    ...
    public function edit_customer() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/edit_customer');
    }
    ...
    function delete_customer($cm_id, $path) {
        ...
        redirect("branch_manager/customer_list");
    }
    ...
    public function customer_list_search() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/customer_list_search');
    }
    ...
    public function customer_profile() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/customer_profile');
    }
    ...
    public function customer_purchase_view() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/customer_purchase_view');
    }
    ...
    public function create_distributor() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/create_distributor');
    }
    ...
    public function distributor_list() {
        ...
        $this->load->model('distributor_management_model', 'dmm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/distributor_list');
    }
    ...
    public function edit_distributor() {
        ...
        $this->load->model('office_setup_model', 'osm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/edit_distributor');
    }
    ...
    function delete_distributor($dis_id) {
        ...
        redirect("branch_manager/distributor_list");
    }
    ...
    public function distributor_list_search() {
        ...
        $this->load->model('distributor_management_model', 'dmm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/distributor_list_search');
    }
    ...
    public function create_supplier() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/create_supplier');
    }
    ...
    public function supplier_list() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/supplier_list');
    }
    ...
    public function edit_supplier() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/edit_supplier');
    }
    ...
    function delete_supplier($sup_id, $path) {
        ...
        unlink(FCPATH . 'uploads/photos/' . $path);
        redirect("branch_manager/supplier_list");
    }
    ...
    public function supplier_list_search() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/supplier_list_search');
    }
    ...
    public function create_inventory() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/create_inventory');
    }
    ...
    public function inventory_view() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/inventory_view');
    }
    ...
    public function inventory_list() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/inventory_list');
    }
    ...
    public function supplier_inventory_list() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/supplier_inventory_list');
    }
    ...
    public function stock_check() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/stock_check');
    }
    ...
    public function outof_stock_check() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/outof_stock_check');
    }
    ...
    public function category_list() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/category_list');
    }
    ...
    public function sub_category_list() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/sub_category_list');
    }
    ...
    public function create_order() {
        ...
        $this->load->model('order_management_model', 'omm');
        $this->load->model('user_registration_model', 'urm');
        $this->load->view('branch_manager/create_order');
    }
    ...
    public function order_list() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/order_list');
    }
    public function order_view() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/order_view');
    }

    public function distributor_statement() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/distributor_statement');
    }

    public function order_list_pending() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/order_list_pending');
    }

    public function order_list_approved() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/order_list_approved');
    }

    public function order_list_reject() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/order_list_reject');
    }
    ...
    public function order_approved() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->omm->order_approved_branch_manager();
    }
    ...
    public function distribution_list() {
        $this->session_data();
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/distribution_list');
    }
    ...
    public function sales_list() {
        ...
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/sales_list');
    }
    public function sales_order_view() {
        ...
        $this->load->model('sales_order_model', 'som');
        $this->load->model('order_management_model', 'omm');
        $this->load->view('branch_manager/sales_order_view');
    }
    ...
    public function purchase_order() {
        ...
        $this->load->model('purchase_model', 'pm');
        $this->load->model('purchase_order_model', 'po');
        $this->load->view('branch_manager/purchase_order');
    }
    ...
    public function purchase_order_list() {
        ...
        $this->load->model('purchase_model', 'pm');
        $this->load->model('purchase_order_model', 'po');
        $this->load->view('branch_manager/purchase_order_list');
    }
    public function purchase_order_view() {
        ...
        $this->load->model('purchase_model', 'pm');
        $this->load->model('purchase_order_model', 'po');
        $this->load->view('branch_manager/purchase_order_view');
    }
    ...
    public function purchase_order_list_pending() {
        ...
        $this->load->model('purchase_model', 'pm');
        $this->load->model('purchase_order_model', 'po');
        $this->load->view('branch_manager/purchase_order_list_pending');
    }
    ...
    public function purchase_order_list_approved() {
        ...
        $this->load->model('purchase_model', 'pm');
        $this->load->model('purchase_order_model', 'po');
        $this->load->view('branch_manager/purchase_order_list_approved');
    }
    ...
    public function purchase_order_list_reject() {
        ...
        $this->load->model('purchase_model', 'pm');
        $this->load->model('purchase_order_model', 'po');
        $this->load->view('branch_manager/purchase_order_list_reject');
    }
    ...
    public function pro_brand_list() {
        ...
        $this->load->model('purchase_order_model', 'po');
        $this->load->model('inventory_management_model', 'imm');
        $this->load->view('branch_manager/pro_brand_list');
    }
    ...
    public function pro_measure_list() {
        ...
        $this->load->model('purchase_order_model', 'po');
        $this->load->model('inventory_management_model', 'imm');
        $this->load->view('branch_manager/pro_measure_list');
    }
    ...
    public function unit_list() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('user_registration_model', 'urm');
        $this->load->view('branch_manager/unit_list');
    }
    ...
    public function department_list() {
        ...
        $this->load->model('inventory_management_model', 'imm');
        $this->load->model('user_registration_model', 'urm');
        $this->load->view('branch_manager/department_list');
    }
