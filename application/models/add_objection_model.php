...
// Create Objection
    function create_objection()
    {
        ...
        $this->form_validation->set_rules("obj_email", "obj_email", "xss_clean");
        $this->form_validation->set_rules("obj_phone", "obj_phone", "xss_clean");
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'obj_email' => $this->input->post('obj_email'),
                'obj_phone' => $this->input->post('obj_phone'),
    ...
    function get_objection_dash() {
        $this->db->order_by("obj_id", "DESC");
        $query = $this->db->get("objections", 4);
        return $query->result();
    }
