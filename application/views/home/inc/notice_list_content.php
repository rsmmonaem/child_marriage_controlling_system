    ...
    <div class="card">
        ...
        <div class="card-body">
            <?php foreach ($this->adm->get_notice() as $row):?>
                <div class="row mb-2">
                    <div class="col-md-6"><a href="<?= base_url();?>home/notice_details/<?= $row->not_id ?>">
                            <img src="<?= base_url();?>uploads/notice/<?= $row->not_thumbnail ?>"
                                 class="card-img-top img-fluid" alt="<?= $row->not_title?>"> </a> </div>
                    <div class="col-md-6">
                        <p class="card-text"><a href="<?= base_url();?>home/notice_details/<?= $row->not_id?>"><i class="bi bi-arrow-right-circle"></i> <?= $row->not_title?></a></p>
