<div class="col">
    <div>
        ...
        <div class="footer-wrapper full-width" id="footer-wrapper">
            ...
            <span>
			    কারিগরি সহায়তায়:
			    <a href="https://a2i.gov.bd" title=""><img style="height: 20px; vertical-align: baseline; width: 30%" src="<?= base_url();?>/uploads/seo-logo.png" alt="a2i"></a>
			</span>
                    <br>
                    <span style="display: none;">
			    সফটওয়্যার তৈরি:
			    <a href="https://seoexpate.com/" target="_blank" title=""><img style="height: 20px; vertical-align: baseline; width: 20%;" src="<?= base_url();?>/uploads/seo-logo.png" alt="https://seoexpate.com/"></a>
			</span>
                </p>
            </div>
        </div>                </div>
