...
<div class="card m-b-30">
    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                <a href="<?= base_url() ?>deo_admin/purohit_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo base_url('deo_admin/update_purohit/'.$data->purohit_id)?>" method="post" enctype="multipart/form-data">
