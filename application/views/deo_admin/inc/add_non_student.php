...
<div class="card m-b-30">
    <div class="card-body">
        <div class="btn-group">
            <div>
                <a href="<?= base_url() ?>deo_admin/non_student_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <form action="<?= base_url() ?>deo_admin/save_non_student" method="post" enctype="multipart/form-data" >
                <div class="col-md-12 col-sm-12">
                    <div class="admission-form">
                        ...
                        <input type="hidden"  name="student_type" value="non_student"   autocomplete="off">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-12 col-xs-12" name="guardian_info_rltn" id="relation_with" value="" placeholder="Relation With Guardian" type="number">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                        </div>
