            ...
            <div class="row">
                <div class="col-12 d-flex">
                    <div class="card mini-stat w-25 mr-3">
                        ...
                        <div class="p-4">
                            <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>/deo_admin/mosque_list">Mosque</a></h6>
                            <a href="<?= base_url()?>/deo_admin/mosque_list" title="Product List">
                    ...
                    <div class="card mini-stat w-25 mr-3">
                        ...
                        <div class="p-4">
                            <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>/deo_admin/temple_list">Temple</a></h6>
                            <a href="<?= base_url()?>/deo_admin/temple_list" title="Product List">
                    ...
                    <div class="card mini-stat w-25 mr-3">
                        ...
                        <div class="p-4">
                            <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>/deo_admin/kazi_list">Kazi</a></h6>
                            <a href="<?= base_url()?>/deo_admin/kazi_list" title="Product List">
                    ...
                    <div class="card mini-stat w-25 mr-3">
                        ...
                        <div class="p-4">
                            <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>/deo_admin/imam_list">Imam</a></h6>
                            <a href="<?= base_url()?>/deo_admin/imam_list" title="Product List">
                    ...
                    <div class="card mini-stat w-25 mr-3">
                        ...
                        <div class="p-4">
                            <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>/deo_admin/purohit_list">Purohit</a></h6>
                            <a href="<?= base_url()?>/deo_admin/purohit_list" title="Product List">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="button-items text-center">
                                <a href="<?= base_url();?>deo_admin/add_mosque" type="button" class="btn btn-primary waves-effect waves-light">Add Mosque</a>
                                <a href="<?= base_url();?>deo_admin/mosque_list" type="button" class="btn btn-warning waves-effect">Mosque List</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="button-items text-center">
                                <a href="<?= base_url();?>deo_admin/add_imam" type="button" class="btn btn-primary waves-effect waves-light">Add Imam</a>
                                <a href="<?= base_url();?>deo_admin/imam_list" type="button" class="btn btn-warning waves-effect">Imam List</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="button-items text-center">
                                <a href="<?= base_url();?>deo_admin/add_kazi" type="button" class="btn btn-primary waves-effect waves-light">Add Kazi</a>
                                <a href="<?= base_url();?>deo_admin/kazi_list" type="button" class="btn btn-warning waves-effect">Kazi List</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <table class="table mb-0">
                                    ...
                                    foreach ($this->atm->get_temple_home() as $row):?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="" class="btn btn-success btn-round" data-toggle="modal" data-target="#m<?=$row->temple_id?>"><i class="fa fa-eye"></i></a>

                                                <div class="modal fade" id="m<?=$row->temple_id?>" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                            ...
                            <div class="button-items text-center">
                                <a href="<?= base_url();?>deo_admin/add_temple" type="button" class="btn btn-primary waves-effect waves-light">Add Temple</a>
                                <a href="<?= base_url();?>deo_admin/temple_list" type="button" class="btn btn-warning waves-effect">Temple List</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="button-items text-center">
                                <a href="<?= base_url();?>deo_admin/add_purohit" type="button" class="btn btn-primary waves-effect waves-light">Add Purohit</a>
                                <a href="<?= base_url();?>deo_admin/purohit_list" type="button" class="btn btn-warning waves-effect">Purohit List</a>
                            </div>
                        </div>
                    </div>
                </div>
