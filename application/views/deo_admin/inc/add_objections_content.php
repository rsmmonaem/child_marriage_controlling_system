...
<div class="card m-b-30">
    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                <a href="<?= base_url() ?>deo_admin/objections_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
...
<div class="row">
    ...
    <form action="<?= base_url() ?>deo_admin/add_objection" method="post" enctype="multipart/form-data">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="field-3" name="obj_description" required="">
