        ...
        <div class="row">
            <div class="col-md-12 col-xl-3">
                <div class="card mini-stat-green">
                    ...
                    <div class="p-4">
                        <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>deo_admin/objections_list">Objections</a></h6>
                        <a href="<?= base_url()?>deo_admin/objections_list" title="Product List">
            ...
            <div class="col-md-12 col-xl-3">
                <div class="card mini-stat-green">
                    ...
                    <div class="p-4">
                        <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>deo_admin/news_list">News</a></h6>
                        <a href="<?= base_url()?>deo_admin/news_list" title="Product List">
            ...
            <div class="col-md-12 col-xl-3">
                <div class="card mini-stat-green">
                    ...
                    <div class="p-4">
                        <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>deo_admin/slider_list">Slider</a></h6>
                        <a href="<?= base_url()?>deo_admin/slider_list" title="Product List">
            ...
            <div class="col-md-12 col-xl-3">
                <div class="card mini-stat-green">
                    ...
                    <div class="p-4">
                        <h6 class="text-uppercase mb-3"><a href="<?= base_url()?>deo_admin/notice_list">Notice</a></h6>
                        <a href="<?= base_url()?>deo_admin/notice_list" title="Product List">
            ...
            <div class="col-md-12 col-xl-3">
                <div class="card mini-stat-green">
                    ...
                    <div class="p-4">
                        <h6 class="text-uppercase mb-3">Marriage</h6>
                        <a href="" title="Product List">
            ...
            <div class="col-md-12 col-xl-3">
                <div class="card mini-stat-green">
                    ...
                    <div class="p-4">
                        <h6 class="text-uppercase mb-3"><a href="">Total Marriage</a></h6>
                        <a href="" title="Product List">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="button-items text-center">
                            <a href="<?= base_url();?>deo_admin/add_objection" type="button" class="btn btn-primary waves-effect waves-light">Create Objection</a>
                            <a href="<?= base_url();?>deo_admin/objections_list" type="button" class="btn btn-warning waves-effect">Objection List</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="button-items text-center">
                            <a href="<?= base_url();?>deo_admin/message_list" type="button" class="btn btn-warning waves-effect">Contact Message List</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body table-data">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td><img class="rounded-circle" src="<?=base_url()?>uploads/student/<?= $row->groom_photo?>" alt="user" width="80"></td>
                                    <td><?= $row->groom_name?></td>
                                    <td> <?= date('l jS \of F Y h:i:s A', strtotime( $row->marriage_date)); ?></td>

                                    <td><img src="<?=base_url()?>uploads/student/<?= $row->bride_photo?>" alt="" width="80"></td>
