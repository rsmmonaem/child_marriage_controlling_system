...
<div class="card m-b-30">
    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
            <a href="<?= base_url() ?>deo_admin/institute_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
...
<div class="row">
    ...
    <form action="<?php echo base_url('deo_admin/update_institute/'.$data->inst_id)?>" method="post" enctype="multipart/form-data">
    <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="field-6" class="control-label">Institute existing Logo</label>
                                <img src="<?= base_url();?>/uploads/institute/<?= $data->inst_logo ?>" alt="" class="img-fluid">
                            </div>
                        </div>
