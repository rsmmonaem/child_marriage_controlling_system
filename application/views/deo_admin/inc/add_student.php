...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <form action="<?= base_url() ?>deo_admin/save_student" method="post" enctype="multipart/form-data" >
                <div class="col-md-12 col-sm-12">
                    <div class="admission-form">
                        ...
                        <input type="hidden"  name="student_type" value="student"   autocomplete="off">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    <label for="birth_certi_id">Birth Certificate ID <span class="required">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    <label for="father_phone">Contect No</label>
                                    <input class="form-control col-md-12 col-xs-12" name="fathers_phone" id="father_phone" value="" placeholder="Father's Phone" type="tel" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    <label for="mother_designation">Father's NID / Birth ID</label>
                                    <input class="form-control col-md-12 col-xs-12" name="fathers_nid" id="mother_designation" value="" placeholder="Father's NID" type="number" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    <label for="mother_phone">Contrect No </label>
                                    <input class="form-control col-md-12 col-xs-12" name="mothers_phone" id="mother_phone" value="" placeholder="Mother's Phone" type="tel" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    <label for="mother_designation">Mother's NID / Birth Id</label>
                                    <input class="form-control col-md-12 col-xs-12" name="mothers_nid" id="mother_designation" value="" placeholder="Mother's NID" type="number" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-12 col-xs-12" name="guardian_info_phone" id="gud_phone" value="" placeholder="Phone" required="required" type="tel" autocomplete="off">
                                    <div class="help-block"></div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    <label for="gud_relation">Relation With Student </label>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-12 col-xs-12" name="guardian_info_nid" id="gud_national_id" value="" placeholder="National ID" type="number" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-12 col-xs-12" name="guardian_info_date_of_birth" id="date" value="" placeholder="Birth Date" type="date" autocomplete="off">
                                    <script>
                                        // 									$('#date').datepicker({
                                        //   format: "yyyy/mm/dd",
                                        //   todayHighlight: true,
