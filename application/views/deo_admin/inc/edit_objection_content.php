...
<div class="card m-b-30">
    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                <a href="<?php echo base_url('deo_admin/objection_list/')?>"  class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
...
<div class="row">
    ...
    <form action="<?php echo base_url('deo_admin/update_objection/'.$data->obj_id)?>" method="post" enctype="multipart/form-data">
        <div class="col-md-12">
