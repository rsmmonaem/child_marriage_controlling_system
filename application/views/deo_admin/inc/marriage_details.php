...
<div class="">
    ...
    <div class="row">
		...
		<div class="col-md-2">
			...
			href="<?= base_url() ?>deo_admin/approve_marriage/<?= $data->marriage_couple_id?>" data-placement="top"
			...
			<a class="btn btn-success btn-sm m-auto" onclick="return confirm('Do you want to Reject?');" href="<?= base_url() ?>deo_admin/reject_marriage/<?= $data->marriage_couple_id?>" data-placement="top" data-toggle="tooltip" data-original-title="Approve">
