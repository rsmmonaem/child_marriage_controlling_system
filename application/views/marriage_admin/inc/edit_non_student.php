...
<div class="card">
    <div class="card-header">
        <h2>Update Non Student</h2>
    </div>
    <div class="card-body">
        <div class="row">
            <form action="<?= base_url() ?>marriage_admin/update_non_student" method="post" enctype="multipart/form-data" >
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="admission-form">
                            ...
                            <div class="row m-1" id="guardianDetails">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="item form-group">
                                        ...
                                        <input class="form-control col-md-12 col-xs-12" name="guardian_info_nid" id="guardianNid" placeholder="National ID" type="text" autocomplete="off" value="<?= $guardian_info->guardian_info_nid?> ">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <p class="af-title">
                                    <strong>Non Student Address:</strong>
                                </p>
                            </div>
                        </div>
