    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="col-md-12" action="<?php echo base_url('marriage_admin/update_profile/'.$user_info->u_id)?>" method="post">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="marriage_type" value="<?= $result->details_type?>">
