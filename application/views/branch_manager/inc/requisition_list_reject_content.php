    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">Rejected Requisition List</h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php $i = 1;
                        foreach ($this->rm->getuser_requisition_reject_admin() as $row) : ?>
                            <tr>
                                <td><?= $i++ ?></td>
                                <td><?= $row->req_no ?></td>
                                <td><?= $row->status ?></td>
                                ...
                                <td><a class="btn btn-danger text-light" href="<?= base_url() ?>common_user/requisition_view/<?= $row->req_no ?>">View</a></td>
