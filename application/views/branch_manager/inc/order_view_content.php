                        ...
                        <div class="col-lg-12 col-xl-4">
                            <div class="d-print-none float-right">
                                ...
                                <?php if ($row->status != "approved") { ?>
                                    ...
                                    <form action="<?= base_url() ?>branch_manager/order_approved" method="post" enctype="multipart/form-data">
                                ...
                                <?php } ?>
                                <a href="<?= base_url() ?>branch_manager/order_list" class="btn btn-warning text-light">Close</a>
