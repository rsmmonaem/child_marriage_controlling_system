                ...
                <ul class="list-inline float-right mb-0">
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                            ...
                            foreach ($this->omm->getorder_list() as $row) : ?>
                                <a href="<?= base_url() ?>branch_manager/order_view/<?= $row->order_no ?>" class="dropdown-item notify-item">
                            ...
                            <!-- All-->
                            <a href="<?= base_url() ?>branch_manager/order_list/" class="dropdown-item notify-item">
                                View All
                            </a>
                        </div>
                    </li>
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <a class="dropdown-item" href="<?= base_url() ?>branch_manager/update_profile"><i class="mdi mdi-account-circle "></i> Profile</a>
