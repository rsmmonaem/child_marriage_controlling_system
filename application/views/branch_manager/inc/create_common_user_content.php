    ...
    <div class="card-body">
        ...
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>super_admin/common_user_list/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="List">
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="<?= base_url() ?>super_admin/insert_common_user" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="cu_name" required>
                        </div>
                    </div>

                    <?php $cu_id_no = mt_rand(100000, 999999); ?>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">C.U ID</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="cu_id_no" required readonly value="UG-CU-<?= $cu_id_no ?>">
                        </div>
                    </div>
                    <div class="form-group row">
