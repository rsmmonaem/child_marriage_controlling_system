    ...
    <div class="card-body">
        ...
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>super_admin/branch_manager_list/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="List">
                    <i class="fas fa-pencil"></i>Branch Manager List
                </a>
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="<?= base_url() ?>super_admin/insert_branch_manager" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="branch_manager" required>
                        </div>
                    </div>

                    <?php $bm_id_no = mt_rand(100000, 999999); ?>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">BRANCH MANAGER ID</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="bm_id_no" required readonly value="<?= $bm_id_no ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="file" name="bm_cv">
                        </div>
                    </div>
