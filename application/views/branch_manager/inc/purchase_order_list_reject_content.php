    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>super_admin/purchase_order_list_pending/" class="btn btn-secondary btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="pending">
                    <i class="fas fa-pencil"></i>Pending PO
                </a>

                <a href="<?= base_url() ?>super_admin/purchase_order_list_approved/" class="btn btn-success btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Approved">
            ...
            <div class="card-body">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <?php $i = 1;
                        foreach ($this->po->getpurchase_order_reject() as $row) : ?>
                            <tr>
                                <td><?= $i++ ?></td>
                                <td><?= $row->po_no ?></td>
                                <td><?= $row->status ?></td>
