    ...
    <div class="col-12">
        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <form action="<?= base_url() ?>super_admin/update_branch_manager" method="post" enctype="multipart/form-data">


                    <h4 class="mt-0 header-title">branch Manager Details</h4> <br>
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="branch_code">
                                ...
                                <?php foreach ($this->osm->get_branch() as $row2) : ?>
                                    <?php $i = 1;
                                    foreach ($this->urm->getonerow_branch_manager() as $row) : ?>
                    ...
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">branch MANAGER NAME</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="branch_manager" value="<?= $row->branch_manager ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">branch MANAGER ID</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="bm_id_no" value="<?= $row->bm_id_no ?>" readonly>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                    ...
                    <input type="hidden" name="image" value="<?= $row->bm_image ?>">
                    <input type="hidden" name="bm_cv" value="<?= $row->bm_cv ?>">
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <a href="<?= base_url() ?>super_admin/branch_manager_list" class="btn btn-danger ml-2">Cancel</a>
                </form>
            </div>
        </div>
    </div>
