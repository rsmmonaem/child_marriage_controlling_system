    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>zonal_manager/stock_check/" class="btn btn-primary btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Stock Check">
                    ...
                    <tbody>
                        ...
                        foreach ($this->imm->getinventory_list() as $row) : ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url() ?>zonal_manager/inventory_view/<?= $row->inventory_no ?>" type="button" class="btn btn-primary">
                                        <?= $row->inventory_no ?>
                                    </a></td>
                                ...
                                <td><?= $row->sub_total ?></td>
                                <td><?= $row->due ?></td>
                                <td><a href="<?= base_url() ?>zonal_manager/inventory_view/<?= $row->inventory_no ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View">
