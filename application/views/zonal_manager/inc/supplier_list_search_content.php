...
<div class="contact-list">
                ...
                <div class="card-body">
                    <div class="input-group">
                        ...
                        <span class="input-group-append">
                            <a href="<?= base_url() ?>super_admin/supplier_list" class="btn btn-effect-ripple btn-warning"><i class="fas fa-undo"></i> Return </a>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <?php $i = 1;
        foreach ($this->imm->search_supplier_result() as $row) : ?>
                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="card-title mt-2">
                            <h5><?= $row->sup_name ?></h5>
                            <p class="m-0">Pay:<?= $row->balance ?>|| Due: <?= $row->balance ?></p>
                        </div>
