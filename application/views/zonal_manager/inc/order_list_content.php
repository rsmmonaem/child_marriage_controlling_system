                    ...
                    <tbody>
                        ...
                        foreach ($this->omm->getorder_list() as $row) : ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url() ?>zonal_manager/order_view/<?= $row->order_no ?>" type="button" class="btn btn-info">
                                        <?= $row->order_no ?>
                                    </a></td>
                                ...
                                <td><?= $row->sub_total ?></td>
                                <td><?= $row->due ?></td>
                                <td><a href="<?= base_url() ?>zonal_manager/order_view/<?= $row->order_no ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View">
