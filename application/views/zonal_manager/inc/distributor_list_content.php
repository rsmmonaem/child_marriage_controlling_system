...
<div class="contact-list">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            ...
                            <!-- <a  href="<?= base_url() ?>zonal_manager/create_distributor/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Create">
            ...
            <div class="card m-b-30">
                <form action="<?= base_url() ?>zonal_manager/search_distributor" method="post" enctype="multipart/form-data">
                    <div class="card-body">
        ...
        <div class="col-md-12 col-xl-4">
            <div class="card text-center">
                ...
                <div class="btn-group">
                    ...
                    <a href="<?= base_url() ?>zonal_manager/order_list/<?= $row->dis_code ?>" class="btn btn-primary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Order List">
                        <i class="fas fa-list"></i>
                    </a>

                    <a href="<?= base_url() ?>zonal_manager/distributor_statement/<?= $row->dis_code ?>" class="btn btn-primary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Statement">
