    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>super_admin/order_list/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Inventory List">
...
<div class="row">
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="<?= base_url() ?>super_admin/insert_order" method="post" enctype="multipart/form-data">
                    <h4 class="mt-0 header-title">Product Entry Details</h4> <br>

                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">FIELD WORKER</label>
                        <div class="col-sm-6">
                            <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" name="fw_id_no" required>
                                <option>Select</option>
                                <?php foreach ($this->urm->getfield_worker() as $fw) : ?>
                                    <option <?php if ($fw_id_no == $fw->fw_id_no) {
                                                echo "selected";
                                            } ?> value="<?= $fw->fw_id_no ?>"><?= $fw->field_worker ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <tbody>
                            ...
                            foreach ($this->omm->getorder_cart() as $row) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/order_cart_delete/<?= $row->or_id ?>/<?= $fw_id_no ?>/<?= $order_no ?>/<?= $order_date ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
                            ...
                            <form action="<?= base_url() ?>super_admin/order_submit" method="post" enctype="multipart/form-data">
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
