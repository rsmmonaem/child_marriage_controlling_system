                    ...
                    <tbody>
                        ...
                        foreach ($this->imm->outof_stock() as $row) : ?>
                            <tr style="color:red">
                                ...
                                <td><?= $row->pro_code ?></td>
                                <td><?= $row->instock ?></td>
                                <td>EDIT || <a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>field_worker/deleteoutofstock/<?= $row->pro_id ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
