        ...
        <div class="card">
            <div class="card-body invoice">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <form action="<?= base_url() ?>field_worker/purchase_order_approved" method="post" enctype="multipart/form-data">
                    ...
                    <form action="<?= base_url() ?>field_worker/purchase_order_reject" method="post" enctype="multipart/form-data">
