                    ...
                    <form class="form-horizontal" action="<?= base_url() ?>login/login_process" method="post">
						...
						<div class="form-group m-t-10 mb-0 row">
                            <div class="col-sm-7 m-t-20">
								...
								<b>mosque_admin :</b><br> user: 449433 password: 407326 <br>
								<b>temple_admin :</b><br> user: 780114 password: 873588 <br>
								<b>Marriage_admin :</b><br> user: 560730 password: 295041 <br>
								<b>Deo_admin :</b><br> user: deo_admin pass: deo_admin <br>
