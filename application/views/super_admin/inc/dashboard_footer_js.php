...
<script src="<?= base_url() ?>assets/backend/plugins/metro/MetroJs.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/sparkline-chart/jquery.sparkline.min.js"></script>
...
<script src="<?= base_url() ?>assets/backend/pages/dashboard.js"></script>
<!-- App js -->
