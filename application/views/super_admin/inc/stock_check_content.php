                        ...
                        foreach ($this->imm->getproduct_stock_exists() as $row) : ?>
                            <tr>
                                ...
                                <!-- <td> -->
                                    ...
                                    ?>
                                        <!-- <a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/deleteproduct/<?= $row->pro_id ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
