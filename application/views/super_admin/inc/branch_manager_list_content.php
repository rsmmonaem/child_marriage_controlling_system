...
<div class="contact-list">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            ...
                            <a href="<?= base_url() ?>super_admin/create_branch_manager/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Create">
    ...
    <div class="contact-list">
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <form action="<?= base_url() ?>super_admin/search_branch_manager" method="post" enctype="multipart/form-data">
                        <div class="card-body">
            ...
            foreach ($this->urm->getbranch_manager() as $row) : ?>
                <div class="col-md-12 col-xl-4">
                    <div class="card text-center">
                        ...
                        <div class="btn-group">
                            <a href="<?= base_url() ?>super_admin/edit_branch_manager/<?= $row->user_id ?>" class="btn btn-primary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Edit">
                                <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/delete_branch_manager/<?= $row->user_id ?>/<?= $row->bm_image ?>/<?= $row->user_name ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
