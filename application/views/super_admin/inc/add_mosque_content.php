...
<div class="card m-b-30">
    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                <a href="<?= base_url() ?>super_admin/mosque_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= base_url() ?>/super_admin/add_mosque/" method="post" enctype="multipart/form-data">
            <div class="col-md-12 col-sm-12">
                <div class="admission-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="birth_certi_id">District<span class="text-danger">*</span></label></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="health_condition">Thana<span class="text-danger">*</span></label></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="health_condition">Pourashava/Union<span class="text-danger">*</span></label></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="health_condition">Village/Mohalla<span class="text-danger">*</span></label></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="name">Present Committee Name <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="dob">Present Committee Date of Birth<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="name">Present Committee Contact Number<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="name">Present Committee Register Number<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="name">Present Committee NID<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="name">Present Committee Father Name<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                <label for="name">Present Committee Mother Name<span class="text-danger">*</span></label>
