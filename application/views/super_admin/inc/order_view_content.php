                                ...
                                <table class="table mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($this->omm->getonerow_order_details() as $row) : ?>
                                            ...
                                            <form action="<?= base_url() ?>field_worker/admin_order_update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-12 col-xl-4 ml-auto align-self-center">
                            <div class="text-center text-muted">
                                ...
                                echo '<h4>' . ucwords($f->format($row->sub_total));
                                echo " Tk Only </h4>";
                                ?>
                            </div>
                        ...
                        <div class="col-lg-12 col-xl-4">
                            <div class="d-print-none float-right">
                                ...
                                <?php if ($row->status != "approved") { ?>
                                    ...
                                    <form action="<?= base_url() ?>super_admin/order_approved" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="submit" name="Approved" value="Approved" class="btn btn-primary text-light">
                                    </form>
                                <?php } ?>
                                <a href="<?= base_url() ?>super_admin/order_list" class="btn btn-warning text-light">Close</a>
