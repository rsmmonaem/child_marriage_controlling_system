    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">Unit/s || <a class="btn btn-warning ml-2" data-toggle="modal" data-target=".create_unit">Add New</a></h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php $i = 1;
                        foreach ($this->urm->getunit() as $row) : ?>
                            <tr>
                                <td><?= $i++ ?></td>
                                <td><?= $row->unit_name ?></td>
                                <td><?= $row->unit_code ?></td>
                                ...
                                <td><a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/unit_delete/<?= $row->unit_id ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
