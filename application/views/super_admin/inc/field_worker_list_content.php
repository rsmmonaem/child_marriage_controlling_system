                ...
                <div class="col-md-12 col-xl-4">
                    <div class="card text-center">
                        <div class="card-body">
                            <div class="">
                                <a href="#">
                                    <img src="<?= base_url() ?>uploads/photos/<?= $row->fw_image ?>" alt="" class=" img-fluid rounded-circle w-60">
                                </a>
                            </div>
                            <div class="card-title mt-2">
                                <h5><?= $row->field_worker ?></h5>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><i class="fas fa-file float-right"></i><a target="_blank" href="<?= base_url() ?>uploads/cv/<?= $row->fw_cv ?>">CV</a></li>
                        ...
                        <div class="btn-group">
                            ...
                            <a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/delete_field_worker/<?= $row->user_id ?>/<?= $row->fw_image ?>/<?= $row->user_name ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
