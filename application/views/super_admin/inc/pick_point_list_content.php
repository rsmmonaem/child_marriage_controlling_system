    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="#" class="btn btn-secondary disabled btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="PickPoint List">
                    ...
                    <tbody>
                        ...
                        foreach ($this->osm->get_all_pick_point() as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/pick_point_delete/<?= $row->pickpoint_id ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete"><i class="fas fa-times"></i></a>
