                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <select class="form-control col-md-12 col-xs-12" name="st_inst_name" id="blood_group">
                                        ...
                                        <?php  foreach ($this->ains->get_institute()as $row) { ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-12 col-xs-12" name="st_class_section" id="birth_certi_id"  placeholder="Student Section" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-12 col-xs-12" name="st_class_roll" id="birth_certi_id"  placeholder="Student Roll" type="number" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <select class="form-control col-md-12 col-xs-12 quick-field" name="st_ward" required="required" onchange="check_guardian_type(this.value);">
                                        ...
                                        <option value="3">Ward 04</option>
                                        <option value="3">Ward 05</option>
                                        <option value="3">Ward 06</option>
                                        <option value="3">Ward 07</option>
                                        <option value="3">Ward 08</option>
                                        <option value="3">Ward 09</option>
                                        <option value="3">Ward 10</option>
                                        <option value="3">Ward 11</option>
                                        <option value="3">Ward 12</option>
                                        <option value="3">Ward 13</option>
