...
<div class="row">
<form action="<?= base_url() ?>super_admin/save_student" method="post" >
                     ...
                     <div class="col-md-3 col-sm-3 col-xs-12">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input class="form-control col-md-12 col-xs-12" name="st_inst_name" id="st_inst_name" value="" placeholder="Institute Name" type="text" autocomplete="off">
                               <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
