                ...
                <div class="sidebar-inner slimscrollleft" id="sidebar-main">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="<?= base_url() ?>super_admin/zonal_manager_list" class="waves-effect"><i class="fas fa-anchor"></i><span>Rejional Manager</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>

                            </li>

                            <li>
                                <a href="<?= base_url() ?>super_admin/branch_manager_list" class="waves-effect"><i class="fas fa-band-aid"></i><span>TSO</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                            ...
                            <li>
                                <a href="<?= base_url() ?>super_admin/field_worker_list_table" class="waves-effect"><i class="fas fa-chalkboard-teacher"></i><span>Sales Officer</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>

                            </li>

                            <li>
                                <a href="<?= base_url() ?>super_admin/customer_list" class="waves-effect"><i class="fas fa-chalkboard-teacher"></i><span>Customer List</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                            ...
                            <li>
                                ...
                                <a href="<?= base_url() ?>super_admin/sales_list" class="waves-effect"><i class="mdi mdi-table"></i><span>Sales List </span><span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>

                            </li>

                            <li>

                                <a href="<?= base_url() ?>super_admin/profit_fact" class="waves-effect"><i class="mdi mdi-table"></i><span>Profit Fact </span><span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
