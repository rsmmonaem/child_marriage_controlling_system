    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="#" class="btn btn-primary disabled btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Branch List">
                    ...
                    <tbody>
                        ...
                        foreach ($this->osm->get_branch() as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/branch_delete/<?= $row->br_id ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
