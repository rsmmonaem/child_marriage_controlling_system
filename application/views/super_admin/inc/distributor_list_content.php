                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            ...
                            <a href="<?= base_url() ?>super_admin/distributor_list_table/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Table View">
                                <i class="fas fa-pencil"></i>List View
                            </a>
    ...
    foreach ($this->dmm->getdistributor() as $row) : ?>
        <div class="col-md-12 col-xl-4">
            <div class="card text-center">
                ...
                <div class="btn-group">
                    <a href="<?= base_url() ?>super_admin/edit_distributor/<?= $row->dis_code ?>" class="btn btn-primary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Edit">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                    <a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>super_admin/delete_distributor/<?= $row->dis_id ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
                        <i class="fas fa-times"></i>
                    </a>
                    <a href="<?= base_url() ?>super_admin/order_list/<?= $row->dis_code ?>" class="btn btn-primary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Order List">
                        <i class="fas fa-list"></i>
                    </a>

                    <a href="<?= base_url() ?>super_admin/distributor_statement/<?= $row->dis_code ?>" class="btn btn-primary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Statement">
