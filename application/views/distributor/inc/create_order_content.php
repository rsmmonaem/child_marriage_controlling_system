    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>distributor/order_list/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Inventory List">
                    <i class="fas fa-pencil"></i>Order List
                </a>
                ...
                <!--  <a  href="<?= base_url() ?>distributor/approved_order/" class="btn btn-primary btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Stock Check">
...
<div class="row">
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="<?= base_url() ?>distributor/insert_order" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <?php } else { ?>
                            ...
                            <?php $order_no = "ORN-" . mt_rand(1000, 9999); ?>
                            <div class="col-sm-4">
            ...
            <div class="card">
                <div class="table-responsive">
                    ...
                    <table class="table">
                        ...
                        $this->db->where('fw_id_no', $fw_id_no);
                        $company_code = $this->db->get("distributor")->row("company_code");
                        $this->db->where('fw_id_no', $fw_id_no);
                        $dis_code = $this->db->get("distributor")->row("dis_code");
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Field Worker: <?= $distributor ?> </th>
                        ...
                        <tbody>
                            ...
                            foreach ($this->omm->getorder_cart() as $row) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>distributor/order_cart_delete/<?= $row->or_id ?>/<?= $fw_id_no ?>/<?= $order_no ?>/<?= $order_date ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
                            ...
                            <form action="<?= base_url() ?>distributor/order_submit" method="post" enctype="multipart/form-data">
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
