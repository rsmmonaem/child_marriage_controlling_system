    ...
    <div class="col-12">
        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <form action="<?= base_url() ?>distributor/update_field_worker" method="post" enctype="multipart/form-data">
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <a href="<?= base_url() ?>distributor/field_worker_list" class="btn btn-danger ml-2">Cancel</a>
                </form>
            </div>
        </div>
    </div>
