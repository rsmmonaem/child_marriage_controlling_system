...
<div class="modal bank_deposit<?= $row->b_id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <form action="<?= base_url() ?>distributor/bank_deposit_dis/" method="post" enctype="multipart/form-data">
        <input type="hidden" name="b_id" value="<?= $row->b_id ?>">
        <input type="hidden" name="dis_code" value="<?= $user_id ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="field-1" class="control-label">Deposit Type</label>
                                <select class="form-control" name="deposit_type" required>
                                    <option value="due_pay">
                                        Due Pay
                                    </option>
                                    <option value="advance">
                                        Advance
                                    </option>
                                    <option value="fw_salary">
                                        FW Salary
                                    </option>
                                    <option value="tso_salary">
                                        TSO Salary
                                    </option>
                                </select>
