    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>distributor/sales_list/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Inventory List">
...
<div class="row">
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="<?= base_url() ?>distributor/insert_sales_order" method="post" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            foreach ($this->som->getsales_cart() as $row) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('Want to delete?');" href="<?= base_url() ?>distributor/sales_cart_delete/<?= $row->so_id ?>/<?= $fw_id_no ?>/<?= $order_no ?>/<?= $order_date ?>" class="btn btn-secondary btn-block mt-0 tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete">
                            ...
                            <form action="<?= base_url() ?>distributor/sales_order_submit" method="post" enctype="multipart/form-data">
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
