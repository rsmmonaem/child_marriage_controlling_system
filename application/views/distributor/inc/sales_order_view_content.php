                                    ...
                                    <tbody>
                                        ...
                                        foreach ($this->som->getonerow_sales_details() as $row) : ?>
                                            <tr>
                                                ...
                                                <form action="<?= base_url() ?>distributor/sales_order_delevered" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-lg-12 col-xl-4">
                            <div class="d-print-none float-right">
                                ...
                                <a href="<?= base_url() ?>distributor/sales_list" class="btn btn-warning text-light">RETURN</a>
