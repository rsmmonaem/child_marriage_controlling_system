                    ...
                    <form class="form-horizontal" action="<?= base_url() ?>login/login_process" method="post">
                        ...
                        <div class="form-group m-t-10 mb-0 row">
                            <div class="col-sm-7 m-t-20">
                                ...
                                <b>common user:</b><br> user: cuser1 password: 1234 <br>
                                <b>Unit Head:</b><br> user: uh1 password: 1234 <br>
                                <b>Approval Officer:</b><br> user: fao1 password: 1234 <br>
                                <b style="color:red">Store Keeper:</b><br> user: store password: 1234 <br>
